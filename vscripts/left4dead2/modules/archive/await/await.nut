...
//{
	...
	//	ThinkEnt = null	// Model #2 version
		CoroutineTasks = {
			...
			{
				ClientPrint(null, DirectorScript.HUD_PRINTTALK, BrightGreen+"_newslot metamethod gottem")
				ClientPrint(null, DirectorScript.HUD_PRINTTALK, OliveGreen+type(key))
			}
		}
	}
	...
	::Await.Delay <- function(seconds, func)
	{
		...
		ClientPrint(null, DirectorScript.HUD_PRINTTALK, BrightGreen+"Created new CoroutineTask")
